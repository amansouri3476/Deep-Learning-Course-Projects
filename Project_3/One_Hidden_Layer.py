...
with tf.name_scope("output_layer"):
    w2 = tf.Variable(tf.random_normal(shape=(number_of_neurons_hidden_layer, 10), mean=0, stddev=2, seed=1000), name="W")
...
# could be provided.
filewriter = tf.summary.FileWriter("learning monitoring_Problem_1")
