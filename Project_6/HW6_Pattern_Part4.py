...
neuron_num = 20  # Number of LSTM cell neurons.
...
cell_11 = tf.summary.scalar('cell_states_neuron_11', states[0][0][10])
cell_12 = tf.summary.scalar('cell_states_neuron_12', states[0][0][11])
cell_13 = tf.summary.scalar('cell_states_neuron_13', states[0][0][12])
cell_14 = tf.summary.scalar('cell_states_neuron_14', states[0][0][13])
cell_15 = tf.summary.scalar('cell_states_neuron_15', states[0][0][14])
cell_16 = tf.summary.scalar('cell_states_neuron_16', states[0][0][15])
cell_17 = tf.summary.scalar('cell_states_neuron_17', states[0][0][16])
cell_18 = tf.summary.scalar('cell_states_neuron_18', states[0][0][17])
cell_19 = tf.summary.scalar('cell_states_neuron_19', states[0][0][18])
cell_20 = tf.summary.scalar('cell_states_neuron_20', states[0][0][19])
...
with tf.Session() as sess:
    ...
    file_writer = tf.summary.FileWriter('cell_states_summary_P4')
    ...
    for test_num in range(1, test + 1):
        ...
        while (result[-1] != 'e' or counter == 0) and len(result) <= 4 * test_num + 6:

            # print(len(next_input))
            # print("Result for K=" + str(test_num) + " for counter=" + str(counter) + " is: " + result)
            counter += 1
    ...
    while (result[-1] != 'e' or counter == 0) and len(result) <= 4 * test + 6:
